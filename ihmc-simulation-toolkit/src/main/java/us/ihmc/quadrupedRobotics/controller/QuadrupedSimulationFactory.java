...
public class QuadrupedSimulationFactory
{
   ...
   public void createControllerManager() throws IOException
   {
      ...
      QuadrupedRuntimeEnvironment runtimeEnvironment = new QuadrupedRuntimeEnvironment(controlDT.get(), sdfRobot.get().getYoTime(), fullRobotModel.get(), jointDesiredOutputList.get(),
                                                                                       sdfRobot.get().getRobotsYoVariableRegistry(), yoGraphicsListRegistry,
                                                                                       yoGraphicsListRegistryForDetachedOverhead, globalDataProducer, footSwitches);

...
public class ThorStateEstimatorParameters extends StateEstimatorParameters
{
   ...
   /*
    * Challenge with Thor is that we need minimum delay in all signal, which is usual but it does matter way more for Thor as there is almost no natural damping.
    ...
    */
   public ThorStateEstimatorParameters(boolean runningOnRealRobot, double estimatorDT, ThorSensorInformation sensorInformation, ThorJointMap jointMap)
   {
      ...
      armJointPositionFilterFrequencyHz = runningOnRealRobot ? 20.0 : Double.POSITIVE_INFINITY;
      jointOutputEncoderVelocityFilterFrequencyHz = runningOnRealRobot ? 20.0 : Double.POSITIVE_INFINITY;
      lowerBodyJointPositionFilterFrequencyHz = runningOnRealRobot ? 20.0 : Double.POSITIVE_INFINITY;
      ...
      angularVelocityFilterFrequencyHz    = runningOnRealRobot ? 75.0 : Double.POSITIVE_INFINITY;
      linearAccelerationFilterFrequencyHz = runningOnRealRobot ? 15.0 : Double.POSITIVE_INFINITY;

      lowerBodyJointVelocityBacklashSlopTime = 0.00;
      armJointVelocityBacklashSlopTime = 0.00;
   ...
   public void configureSensorProcessing(SensorProcessing sensorProcessing)
   {
      ...
      YoDouble jointOutputEncoderVelocityAlphaFilter = sensorProcessing.createAlphaFilter("jointOutputEncoderVelocityAlphaFilter", jointOutputEncoderVelocityFilterFrequencyHz);
      ...
      YoDouble lowerBodyJointVelocityAlphaFilter = sensorProcessing.createAlphaFilter("lowerBodyJointVelocityAlphaFilter", lowerBodyJointVelocityFilterFrequencyHz);
      ...
      YoDouble lowerBodyJointPositionAlphaFilter = sensorProcessing.createAlphaFilter("lowerBodyJointPositionAlphaFilter", lowerBodyJointPositionFilterFrequencyHz);
...
//      return 0.4261; // alpha = 0.992 with dt = 0.003
   ...
   /**
    * Pairs of IMUs to use to compute velocities of the joints between them.
    * @return {@code List<Pair<String, String>>} the first element is the name of one parent link IMU, the second is the name of the child link IMU.
    */
   @Override

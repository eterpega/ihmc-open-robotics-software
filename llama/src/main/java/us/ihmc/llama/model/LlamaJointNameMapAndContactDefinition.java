...
public class LlamaJointNameMapAndContactDefinition implements QuadrupedJointNameMap, ContactPointDefinitionHolder
{
   private final String modelName = "llama";
   ...
   public LlamaJointNameMapAndContactDefinition(LlamaPhysicalProperties physicalProperties)
   {
      ...
      for (LlamaOrderedJointMap joint : LlamaOrderedJointMap.values())
      {

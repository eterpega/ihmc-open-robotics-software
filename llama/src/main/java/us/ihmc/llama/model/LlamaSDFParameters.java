...
public class LlamaSDFParameters implements SDFParameters
{
   private static final String SDF_MODEL_NAME = "llama";
   ...
   private static final Path SDF_MODEL_PATH = Paths.get("models", "llama_description", "model", "sdf", SDF_MODEL_NAME + ".sdf");

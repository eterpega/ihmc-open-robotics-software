...
public class LlamaModelFactory extends QuadrupedModelFactory
{
   private final LlamaSDFParameters sdfParameters = new LlamaSDFParameters();
   private final GeneralizedSDFRobotModel generalizedSDFRobotModel;

   private JaxbSDFLoader loader;

   private final LlamaJointNameMapAndContactDefinition jointMapAndContactInfo;

   private final RobotDescription robotDescription;

   public LlamaModelFactory()
   {
      jointMapAndContactInfo = new LlamaJointNameMapAndContactDefinition(new LlamaPhysicalProperties());

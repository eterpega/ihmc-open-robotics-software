...
public class SensorProcessing implements SensorOutputMapReadOnly, SensorRawOutputMapReadOnly
{
                                                                     ...
                                                                     boolean forVizOnly, String... sensorsToIgnore)
   {
      ...
      for (int i = 0; i < imuSensorDefinitions.size(); i++)
      {
         ...
         YoFrameVector processedAngularVelocity = new YoFrameVector(angularVelocityPrefix, angularVelocitySuffix, sensorFrame, registry);
         ...
         if (useStateEstimatorData)
         {
            ...
            orientationProcessors.add(new ProcessingYoVariable()
            {
               ...
               public void update()
               {
                  ...
                  filter.update(intermediateAngularVelocity.getFrameTuple(), virtualAccelerometerMeasurement, virtualMagnetometerMeasurement);

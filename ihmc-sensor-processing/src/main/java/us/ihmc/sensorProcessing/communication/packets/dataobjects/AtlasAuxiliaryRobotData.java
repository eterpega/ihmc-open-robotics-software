...
public class AtlasAuxiliaryRobotData extends Packet<AtlasAuxiliaryRobotData>
{
   ...
   public TempPreallocatedList<Vector3D32> rawImuRates = new TempPreallocatedList<>(Vector3D32.class, Vector3D32::new, 15);
   public TempPreallocatedList<Vector3D32> rawImuDeltas = new TempPreallocatedList<>(Vector3D32.class, Vector3D32::new, 15);

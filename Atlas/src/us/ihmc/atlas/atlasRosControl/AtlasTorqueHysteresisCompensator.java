...
public class AtlasTorqueHysteresisCompensator
{
   ...
   public AtlasTorqueHysteresisCompensator(List<YoEffortJointHandleHolder> yoEffortJointHandleHolders, YoDouble yoTime, YoVariableRegistry parentRegistry)
   {

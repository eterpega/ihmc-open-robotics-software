...
public class AtlasAccelerationIntegration
{
   ...
   public AtlasAccelerationIntegration(List<YoEffortJointHandleHolder> yoEffortJointHandleHolders, double updateDT, YoVariableRegistry parentRegistry)
   {

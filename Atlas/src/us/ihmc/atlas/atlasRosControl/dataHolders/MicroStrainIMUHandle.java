package us.ihmc.atlas.atlasRosControl.dataHolders;
...
import us.ihmc.valkyrie.imu.MicrostrainUDPPacketListener; // files don't exist for atlas
...
public class MicroStrainIMUHandle implements IMUHandle
{
   ...
   /* package-private */ MicroStrainIMUHandle(String name, Integer id)
   {
      ...
      try
      {
         imuListener = MicrostrainUDPPacketListener.createRealtimeListener(AtlasPriorityParameters.IMU_PRIORITY, id);
      }
      catch (IOException e)
      {

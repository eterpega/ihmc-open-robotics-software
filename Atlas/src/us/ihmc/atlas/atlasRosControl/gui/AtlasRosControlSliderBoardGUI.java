package us.ihmc.atlas.atlasRosControl.gui;
...
public class AtlasRosControlSliderBoardGUI extends SCSVisualizer
{
   public AtlasRosControlSliderBoardGUI(int bufferSize)
   {
      super(bufferSize);
   }
   ...
   public void starting(SimulationConstructionSet scs, Robot robot, YoVariableRegistry registry)
   {
      ...
      YoEnum<?> selectedJoint = (YoEnum<?>) registry.getVariable("AtlasRosControlSliderBoard", "selectedJoint");
      
      YoVariable<?> q_d = registry.getVariable("AtlasRosControlSliderBoard", "qDesiredSelected");
      YoVariable<?> qd_d = registry.getVariable("AtlasRosControlSliderBoard", "qdDesiredSelected");

      YoVariable<?> kp = registry.getVariable("AtlasRosControlSliderBoard", "kpSelected");
      YoVariable<?> kd = registry.getVariable("AtlasRosControlSliderBoard", "kdSelected");

      YoVariable<?> masterScaleFactor = registry.getVariable("AtlasRosControlSliderBoard", "masterScaleFactor");
   ...
   {
      SCSVisualizer scsYoVariablesUpdatedListener = new AtlasRosControlSliderBoardGUI(16384);

...
public class AtlasRosControlSensorReader implements SensorReader, JointTorqueOffsetProcessor
{
   ...
   private final AtlasRosControlLowLevelController lowlLevelController;

   public AtlasRosControlSensorReader(StateEstimatorSensorDefinitions stateEstimatorSensorDefinitions,
         ...
         List<YoIMUHandleHolder> yoIMUHandleHolders, List<YoForceTorqueSensorHandle> yoForceTorqueSensorHandles, YoVariableRegistry registry)
   {
      ...
      lowlLevelController = new AtlasRosControlLowLevelController(timestampProvider, estimatorDT, yoEffortJointHandleHolders, yoPositionJointHandleHolders, registry);
   }

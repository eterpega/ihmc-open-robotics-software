 ...
 */
class PositionJointHolder extends AtlasSliderBoardJointHolder
{
   private final PositionJointHandle handle;
   private final DeltaLimitedYoVariable positionStepSizeLimiter;

   public PositionJointHolder(AtlasRosControlSliderBoard atlasRosControlSliderBoard, OneDoFJoint joint, PositionJointHandle handle,

...
import static us.ihmc.atlas.atlasRosControl.AtlasRosControlController.forceTorqueSensorModelNames;
import static us.ihmc.atlas.atlasRosControl.AtlasRosControlController.readForceTorqueSensors;
import static us.ihmc.atlas.atlasRosControl.AtlasRosControlController.readIMUs;
...
import us.ihmc.atlas.atlasRosControl.AtlasPriorityParameters;
import us.ihmc.atlas.atlasRosControl.AtlasRosControlController;
import us.ihmc.atlas.atlasRosControl.AtlasRosControlSensorReader;
import us.ihmc.atlas.atlasRosControl.AtlasRosControlSensorReaderFactory;
...
public class AtlasAutomatedDiagnosticController extends IHMCWholeRobotControlJavaBridge
{
   ...
   private final AtlasRobotModel robotModel = new AtlasRobotModel(AtlasRobotVersion.ATLAS_UNPLUGGED_V5_DUAL_ROBOTIQ, RobotTarget.REAL_ROBOT, false, null);
   ...
   public AtlasAutomatedDiagnosticController()
   {
   ...
   protected void init()
   {
      ...
      yoVariableServer = new YoVariableServer(getClass(), new PeriodicRealtimeThreadSchedulerFactory(AtlasPriorityParameters.LOGGER_PRIORITY),
      ...
      AtlasDiagnosticParameters diagnosticParameters = new AtlasDiagnosticParameters(DiagnosticEnvironment.RUNTIME_CONTROLLER, robotModel, true);
      ...
      AtlasRosControlSensorReaderFactory sensorReaderFactory = new AtlasRosControlSensorReaderFactory(timestampProvider,
       ...
       */
      double gravity = AtlasRosControlController.gravity;

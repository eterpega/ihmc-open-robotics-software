...
public abstract class EndToEndWholeBodyTrajectoryMessageTest implements MultiRobotTestInterface
{
   ...
   public void testSingleWaypoint() throws Exception
   {
      ...
      wholeBodyTrajectoryMessage.setPelvisTrajectoryMessage(HumanoidMessageTools.createPelvisTrajectoryMessage(trajectoryTime, desiredPosition, desiredOrientation));
...
//      EndToEndPelvisTrajectoryMessageTest.assertSingleWaypointExecuted(desiredPosition, desiredOrientation, scs);
   ...
   public void testSingleWaypointUsingMessageOfMessages() throws Exception
   {
      ...
      desiredFootPose.changeFrame(worldFrame);
      desiredFootPose.get(desiredPosition, desiredOrientation);
      messageOfMessages.addPacket(HumanoidMessageTools.createFootTrajectoryMessage(footSide, trajectoryTime, desiredPosition, desiredOrientation));
      ...
      for (RobotSide robotSide : RobotSide.values)
      {
         ...
         desiredOrientation = new Quaternion();
         desiredRandomHandPose.get(desiredPosition, desiredOrientation);
         messageOfMessages.addPacket(HumanoidMessageTools.createHandTrajectoryMessage(robotSide, trajectoryTime, desiredPosition, desiredOrientation, worldFrame));
      }
      ...
      desiredPelvisPose.changeFrame(worldFrame);
      desiredPelvisPose.get(desiredPosition, desiredOrientation);
      messageOfMessages.addPacket(HumanoidMessageTools.createPelvisTrajectoryMessage(trajectoryTime, desiredPosition, desiredOrientation));

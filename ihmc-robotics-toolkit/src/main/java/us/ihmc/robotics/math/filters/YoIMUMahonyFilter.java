...
public class YoIMUMahonyFilter implements ProcessingYoVariable
{
   ...
   private final YoFrameVector rawAngularVelocity;
   private final YoFrameVector rawLinearAcceleration;
   private final YoFrameVector rawMagneticVector;
   ...
   public YoIMUMahonyFilter(String imuName, String namePrefix, String nameSuffix, double updateDT, ReferenceFrame sensorFrame,
                            YoFrameVector inputAngularVelocity, YoFrameVector inputLinearAcceleration, YoVariableRegistry parentRegistry)
   {
      this(imuName, namePrefix, nameSuffix, updateDT, sensorFrame, inputAngularVelocity, inputLinearAcceleration, null, parentRegistry);
   }

   public YoIMUMahonyFilter(String imuName, String namePrefix, String nameSuffix, double updateDT, ReferenceFrame sensorFrame,
                            YoFrameVector inputAngularVelocity, YoFrameVector inputLinearAcceleration, YoFrameVector inputMagneticVector,
                            YoVariableRegistry parentRegistry)
   {

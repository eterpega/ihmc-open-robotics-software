...
public class YoIMUMahonyFilter implements ProcessingYoVariable
{
   ...
   private YoFrameVector rawAngularVelocity;
   private YoFrameVector rawLinearAcceleration;
   private YoFrameVector rawMagneticVector;

   private final YoFrameQuaternion estimatedOrientation;
   private final YoFrameVector estimatedAngularVelocity;

   private final YoFrameVector yoErrorTerm;
   private final YoFrameVector yoIntegralTerm;
   ...
   public YoIMUMahonyFilter(String imuName, String nameSuffix, double updateDT, ReferenceFrame sensorFrame, YoFrameQuaternion estimatedOrientation,
                            YoFrameVector estimatedAngularVelocity, YoVariableRegistry parentRegistry)
   {
      ...
      yoErrorTerm = new YoFrameVector("ErrorTerm", nameSuffix, sensorFrame, registry);
      yoIntegralTerm = new YoFrameVector("IntegralTerm", nameSuffix, sensorFrame, registry);
                            ...
                            YoVariableRegistry parentRegistry)
   {
      ...
      estimatedAngularVelocity = new YoFrameVector(namePrefix, nameSuffix, sensorFrame, registry);
    ...
    */
   public void setInputs(YoFrameVector inputAngularVelocity, YoFrameVector inputLinearAcceleration)
   {
    ...
    */
   public void setInputs(YoFrameVector inputAngularVelocity, YoFrameVector inputLinearAcceleration, YoFrameVector inputMagneticVector)
   {
   ...
   public void update()
   {
      Vector3DReadOnly inputAngularVelocity = rawAngularVelocity.getFrameTuple();
      Vector3DReadOnly inputLinearAcceleration = rawLinearAcceleration.getFrameTuple();

      if (rawMagneticVector != null)
         update(inputAngularVelocity, inputLinearAcceleration, rawMagneticVector.getFrameTuple());
      else
   ...
   public void update(Vector3DReadOnly inputAngularVelocity, Vector3DReadOnly inputLinearAcceleration, Vector3DReadOnly inputMagneticVector)
   {
      ...
      boolean success = computeOrientationError(estimatedOrientation.getFrameOrientation(), inputLinearAcceleration, inputMagneticVector, quaternionUpdate);
      if (success)
      {
         quaternionUpdate.get(totalError);
         yoErrorTerm.set(totalError);

         integralTerm.scaleAdd(integralGain.getValue() * updateDT, yoErrorTerm.getFrameTuple(), yoIntegralTerm.getFrameTuple());
      ...
      quaternionUpdate.set(rotationUpdate);
   ...
   {
      boolean success = computeOrientationError(estimatedOrientation.getFrameOrientation(), acceleration, magneticVector, quaternionUpdate);
   ...
   public YoFrameVector getErrorTerm()
   {
      return yoErrorTerm;
   }

   public YoFrameVector getIntegralTerm()
   {

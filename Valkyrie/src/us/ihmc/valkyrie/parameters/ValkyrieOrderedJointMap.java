...
public class ValkyrieOrderedJointMap
{
   ...
   public final static int LeftToePitch = 6; // added joint for toe
   public final static int RightHipYaw= 7;
   public final static int RightHipRoll= 8;
   public final static int RightHipPitch= 9;
   public final static int RightKneePitch= 10;
   public final static int RightAnklePitch= 11;
   public final static int RightAnkleRoll= 12;
   public final static int RightToePitch= 13; // added joint for toe
   public final static int TorsoYaw= 14;
   public final static int TorsoPitch= 15;
   public final static int TorsoRoll= 16;
   public final static int LeftShoulderPitch= 17;
   public final static int LeftShoulderRoll= 18;
   public final static int LeftShoulderYaw= 19;
   public final static int LeftElbowPitch= 20;
   public final static int LeftForearmYaw= 21;
   public final static int LeftWristRoll= 22;
   public final static int LeftWristPitch= 23;
   public final static int LeftIndexFingerPitch1= 24;
   public final static int LeftIndexFingerPitch2= 25;
   public final static int LeftIndexFingerPitch3= 26;
   public final static int LeftMiddleFingerPitch1= 27;
   public final static int LeftMiddleFingerPitch2= 28;
   public final static int LeftMiddleFingerPitch3= 29;
   public final static int LeftPinkyPitch1= 30;
   public final static int LeftPinkyPitch2= 31;
   public final static int LeftPinkyPitch3= 32;
   public final static int LeftThumbRoll= 33;
   public final static int LeftThumbPitch1= 34;
   public final static int LeftThumbPitch2= 35;
   public final static int LeftThumbPitch3= 36;
   public final static int LowerNeckPitch= 37;
   public final static int NeckYaw= 38;
   public final static int UpperNeckPitch= 39;
   public final static int MultisenseSLSpinnyJointFrame= 40;
   public final static int RightShoulderPitch= 41;
   public final static int RightShoulderRoll= 42;
   public final static int RightShoulderYaw= 43;
   public final static int RightElbowPitch= 44;
   public final static int RightForearmYaw= 45;
   public final static int RightWristRoll= 46;
   public final static int RightWristPitch= 47;
   public final static int RightIndexFingerPitch1= 48;
   public final static int RightIndexFingerPitch2= 49;
   public final static int RightIndexFingerPitch3= 50;
   public final static int RightMiddleFingerPitch1= 51;
   public final static int RightMiddleFingerPitch2= 52;
   public final static int RightMiddleFingerPitch3= 53;
   public final static int RightPinkyPitch1= 54;
   public final static int RightPinkyPitch2= 55;
   public final static int RightPinkyPitch3= 56;
   public final static int RightThumbRoll= 57;
   public final static int RightThumbPitch1= 58;
   public final static int RightThumbPitch2= 59;
   public final static int RightThumbPitch3= 60;
   ...
   static
   {
      ...
      jointNames[LeftToePitch] = "leftToePitch"; // added joint for toe
      ...
      jointNames[RightToePitch] = "rightToePitch"; // added joint for toe
   ...
   static
   {
      ...
      jointNamesRight[LeftToePitch] = "rightToePitch"; // added joint for toe
      ...
      jointNamesRight[RightToePitch] = "rightToePitch"; // added joint for toe
      ...
      jointNamesLeft[LeftToePitch] = "leftToePitch"; // added joint for toe
      ...
      jointNamesLeft[RightToePitch] = "leftToePitch"; // added joint for toe

...
public class PlanarRegionsListHandler
{
   ...
   public PlanarRegionsListHandler(StatusMessageOutputManager statusMessageOutputManager, YoVariableRegistry parentRegistry)
   {
      this.statusMessageOutputManager = statusMessageOutputManager;

      planarRegions.clear();
      requestPlanarRegionsListMessage.setDestination(PacketDestination.CONTROLLER);
   ...
   public void requestPlanarReqions()
   {
      statusMessageOutputManager.reportStatusMessage(requestPlanarRegionsListMessage);

...
public class SpatialDataRegion
{
   ...
   public void getRandomSpatialData(ExploringRigidBody exploringRigidBody)
   {
      ...
      spatialData.getPosition().setX(positionLowerLimitSpace.getX() + (positionUpperLimitSpace.getX() - positionLowerLimitSpace.getX())*randomManager.nextDouble());
      spatialData.getPosition().setY(positionLowerLimitSpace.getY() + (positionUpperLimitSpace.getY() - positionLowerLimitSpace.getY())*randomManager.nextDouble());
      spatialData.getPosition().setZ(positionLowerLimitSpace.getZ() + (positionUpperLimitSpace.getZ() - positionLowerLimitSpace.getZ())*randomManager.nextDouble());
      
      Vector3D rotationVector = new Vector3D();
      
      rotationVector.setX(rotationVectorLowerLimitSpace.getX() + (rotationVectorLowerLimitSpace.getX() - rotationVectorUpperLimitSpace.getX())*randomManager.nextDouble());
      rotationVector.setY(rotationVectorLowerLimitSpace.getY() + (rotationVectorLowerLimitSpace.getY() - rotationVectorUpperLimitSpace.getY())*randomManager.nextDouble());
      rotationVector.setZ(rotationVectorLowerLimitSpace.getZ() + (rotationVectorLowerLimitSpace.getZ() - rotationVectorUpperLimitSpace.getZ())*randomManager.nextDouble());
      
      spatialData.setOrientation(new AxisAngle(rotationVector));      
      
      exploringRigidBody.setSpatialData(spatialData);
   }

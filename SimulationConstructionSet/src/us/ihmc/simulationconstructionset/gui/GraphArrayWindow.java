...
public class GraphArrayWindow implements SelectGraphConfigurationCommandExecutor, GraphGroupSelector {
    ...
    public GraphArrayWindow(AllCommandsExecutor allCommandsExecutor, SimulationConstructionSet sim, GUIEnablerAndDisabler guiEnablerAndDisabler, ConfigurationList configurationList,
                            ...
                            SelectedVariableHolder selectedVariableHolder, SelectedFilterHolder selectedFilterHolder, DataBuffer dataBuffer, StandardGUIActions mainGUIActions, int screenID, Point windowLocation,
        ...
        myGraphArrayPanel = new GraphArrayPanel(selectedVariableHolder, selectedFilterHolder, dataBuffer, frame, sim.getGUI());

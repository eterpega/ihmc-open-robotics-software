...
public class YoGraphTester {
    public void testYoGraph() {
        ...
        SelectedFilterHolder selectedFilterHolder = new SelectedFilterHolder();
        ...
        YoGraph yoGraph = new YoGraph(graphIndicesHolder, yoGraphRemover, selectedVariableHolder, selectedFilterHolder, dataEntryHolder, timeDataHolder, jFrame);

...
public class TriWheelCartDescription extends RobotDescription
{
   ...
   public TriWheelCartDescription(String name)
   {
      ...
      PinJointDescription rightWheelJoint = createWheelJoint("rightwheel",
                                                                   ...
                                                                   radiusActiveWheel, thicknessActiveWheel,
                                                                   YoAppearance.Black());
      ...
      PinJointDescription casterWheelJoint = createWheelJoint("casterwheel",
                                                            new Vector3D(-offsetXCasterWheel, 0.0, 0.0),
                                                            radiusCasterWheel, thicknessCasterWheel,
                                                            YoAppearance.Aqua());

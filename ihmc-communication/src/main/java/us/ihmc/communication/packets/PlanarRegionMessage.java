...
public class PlanarRegionMessage extends Packet<PlanarRegionMessage>
{
   ...
   public TempPreallocatedList<Polygon2DMessage> convexPolygons = new TempPreallocatedList<>(Polygon2DMessage.class, Polygon2DMessage::new, 20);
   ...
   public TempPreallocatedList<Polygon2DMessage> getConvexPolygons()
   {

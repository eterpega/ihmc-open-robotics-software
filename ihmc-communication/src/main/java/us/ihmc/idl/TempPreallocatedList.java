 ...
 */
@Deprecated
public class TempPreallocatedList<T>
{
   ...
   public TempPreallocatedList(Class<T> clazz, ListAllocator<T> allocator, int maxSize)
   {
      this.clazz = clazz;
   ...
   public TempPreallocatedList(Class<T> clazz, Enum[] constants, int maxSize)
   {
      this.clazz = clazz;
      this.values = (T[]) Array.newInstance(clazz, maxSize);
      this.isEnum = true;
   ...
   public boolean equals(Object obj)
   {
      ...
      if (getClass() != obj.getClass())
         return false;
      TempPreallocatedList<?> other = (TempPreallocatedList<?>) obj;
      if (clazz == null)
      {
         if (other.clazz != null)
            return false;

...
public class EscherStateEstimatorParameters extends StateEstimatorParameters
{
   ...
   /*
    * Challenge with Escher is that we need minimum delay in all signal, which is usual but it does matter way more for Escher as there is almost no natural damping.
    ...
    */
   public EscherStateEstimatorParameters(boolean runningOnRealRobot, double estimatorDT, EscherSensorInformation sensorInformation, EscherJointMap jointMap)
   {

...
public class AnytimeFootstepPlannerOnRoughTerrainTest implements PlanningTest
{
   ...
   public void testOverCinderBlockFieldWithGoalTooFarAway()
   {
      ...
      FootstepPlan bestPlan = checkThatPlannerKeepsGettingCloserToGoal(anytimePlanner, goalPoses, Double.MAX_VALUE);
   ...
   public void testOverCinderBlockFieldWithIncrementalKnowledgeOfTerrain()
   {
      ...
      FootstepPlan bestPlanYet = checkThatPlannerKeepsGettingCloserToGoal(anytimePlanner, goalPoses, closestDistanceOfFootstepToGoal);
      anytimePlanner.setPlanarRegions(cinderBlockFieldTwoThirds);
      bestPlanYet = checkThatPlannerKeepsGettingCloserToGoal(anytimePlanner, goalPoses, closestDistanceOfFootstepToGoal);
   ...
   private FootstepPlan checkThatPlannerKeepsGettingCloserToGoal(SimplePlanarRegionBipedalAnytimeFootstepPlanner anytimePlanner, SideDependentList<FramePose> goalPoses, double initialClosestDistanceToGoal)
   {

...
public class MomentumBasedControllerFactory implements CloseableAndDisposable
{
   ...
   private HighLevelHumanoidControllerToolbox momentumBasedController = null;
   ...
   public MomentumBasedControllerFactory(ContactableBodiesFactory contactableBodiesFactory, SideDependentList<String> footForceSensorNames,
         ...
         WholeBodyControllerCoreMode initialControllerCoreMode)
   {
      ...
      this.initialControllerCoreMode = initialControllerCoreMode;
         ...
         CenterOfPressureDataHolder centerOfPressureDataHolderForEstimator, InverseDynamicsJoint... jointsToIgnore)
   {
      ...
      momentumBasedController = new HighLevelHumanoidControllerToolbox(fullRobotModel, geometricJacobianHolder, referenceFrames, footSwitches, wristForceSensors, yoTime,
      ...
      RigidBody[] controlledBodies = {fullRobotModel.getFoot(RobotSide.LEFT), fullRobotModel.getFoot(RobotSide.RIGHT), fullRobotModel.getHand(RobotSide.LEFT),
            fullRobotModel.getHand(RobotSide.RIGHT), fullRobotModel.getPelvis(), fullRobotModel.getChest(), fullRobotModel.getHead()};
      ...
      WholeBodyControlCoreToolbox toolbox = new WholeBodyControlCoreToolbox(fullRobotModel, controlledBodies, jointsToOptimizeFor, momentumOptimizationSettings, referenceFrames,
            controlDT, gravityZ, geometricJacobianHolder, twistCalculator, contactablePlaneBodies, yoGraphicsListRegistry, registry);

...
public final class SO3TrajectoryMessage extends Packet<SO3TrajectoryMessage>
{
   ...
   public TempPreallocatedList<SO3TrajectoryPointMessage> taskspaceTrajectoryPoints = new TempPreallocatedList<>(SO3TrajectoryPointMessage.class, SO3TrajectoryPointMessage::new, 2000);
   ...
   public final TempPreallocatedList<SO3TrajectoryPointMessage> getTrajectoryPoints()
   {

...
public final class EuclideanTrajectoryMessage extends Packet<EuclideanTrajectoryMessage>
{
   ...
   public TempPreallocatedList<EuclideanTrajectoryPointMessage> taskspaceTrajectoryPoints = new TempPreallocatedList<>(EuclideanTrajectoryPointMessage.class, EuclideanTrajectoryPointMessage::new, 2000);
    ...
    * @return
    */
   public final TempPreallocatedList<EuclideanTrajectoryPointMessage> getTrajectoryPoints()
   {

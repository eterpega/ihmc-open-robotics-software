...
public final class SE3TrajectoryMessage extends Packet<SE3TrajectoryMessage>
{
   ...
   public TempPreallocatedList<SE3TrajectoryPointMessage> taskspaceTrajectoryPoints = new TempPreallocatedList<>(SE3TrajectoryPointMessage.class, SE3TrajectoryPointMessage::new, 2000);
   ...
   public final TempPreallocatedList<SE3TrajectoryPointMessage> getTrajectoryPoints()
   {

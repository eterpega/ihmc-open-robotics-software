...
public class FootstepDataMessage extends Packet<FootstepDataMessage>
{
   ...
   public TempPreallocatedList<Point3D> positionWaypoints = new TempPreallocatedList<>(Point3D.class, Point3D::new, 2);
   ...
   public TempPreallocatedList<SE3TrajectoryPointMessage> swingTrajectory = new TempPreallocatedList<>(SE3TrajectoryPointMessage.class, SE3TrajectoryPointMessage::new,
                                                                                               50);
   ...
   public TempPreallocatedList<Point3D> getCustomPositionWaypoints()
   {
   ...
   public TempPreallocatedList<SE3TrajectoryPointMessage> getSwingTrajectory()
   {

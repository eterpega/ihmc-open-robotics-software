...
public final class JointspaceTrajectoryMessage extends Packet<JointspaceTrajectoryMessage>
{
   ...
   public TempPreallocatedList<OneDoFJointTrajectoryMessage> jointTrajectoryMessages = new TempPreallocatedList<>(OneDoFJointTrajectoryMessage.class, OneDoFJointTrajectoryMessage::new, 10);
   ...
   public TempPreallocatedList<OneDoFJointTrajectoryMessage> getTrajectoryPointLists()
   {

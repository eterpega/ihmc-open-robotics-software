...
public class SimplexPolytopeTest
{
   ...
   public void testGetClosestPointToOriginOnConvexHull()
   {
      ...
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(1.0, 2.0, 3.0), closestPointToOrigin, 1e-7);
      ...
      simplex.getClosestPointToOriginOnConvexHullAndRemoveUnusedVertices(closestPointToOrigin);
      assertLambdasOnSimplex(simplex);
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(1.0, 2.0, 2.5), closestPointToOrigin, 1e-7);
      assertEquals(1, simplex.getNumberOfPoints());
      ...
      simplex.getClosestPointToOriginOnConvexHullAndRemoveUnusedVertices(closestPointToOrigin);
      assertLambdasOnSimplex(simplex);
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(1.0, 2.0, 0.0), closestPointToOrigin, 1e-7);
      ...
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(0.0, 2.0, 0.0), closestPointToOrigin, 1e-7);
      ...
      simplex.getClosestPointToOriginOnConvexHullAndRemoveUnusedVertices(closestPointToOrigin);
      assertLambdasOnSimplex(simplex);
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(1.0, 1.0, 1.0), closestPointToOrigin, 1e-7);
      assertEquals(1, simplex.getNumberOfPoints());
      assertTrue(simplex.containsPoint(pointOne));
      assertFalse(simplex.containsPoint(pointTwo));
      assertFalse(simplex.containsPoint(pointThree));
      ...
      simplex.getClosestPointToOriginOnConvexHullAndRemoveUnusedVertices(closestPointToOrigin);
      assertLambdasOnSimplex(simplex);
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(1.0, 1.0, 0.0), closestPointToOrigin, 1e-7);
      assertEquals(2, simplex.getNumberOfPoints());
      assertTrue(simplex.containsPoint(pointOne));
      assertFalse(simplex.containsPoint(pointTwo));
      assertFalse(simplex.containsPoint(pointThree));
      ...
      simplex.getClosestPointToOriginOnConvexHullAndRemoveUnusedVertices(closestPointToOrigin);
      assertLambdasOnSimplex(simplex);
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(1.0, 0.0, 0.0), closestPointToOrigin, 1e-7);
      assertEquals(3, simplex.getNumberOfPoints());
      assertTrue(simplex.containsPoint(pointOne));
      assertTrue(simplex.containsPoint(pointTwo));
      assertFalse(simplex.containsPoint(pointThree));
      ...
      simplex.getClosestPointToOriginOnConvexHullAndRemoveUnusedVertices(closestPointToOrigin);
      assertLambdasOnSimplex(simplex);
      EuclidCoreTestTools.assertTuple3DEquals("", new Point3D(0.0, 0.0, 0.0), closestPointToOrigin, 1e-7);

...
public interface ConvexPolytopeFaceReadOnly extends EpsilonComparable<ConvexPolytopeFaceReadOnly>, Clearable
{
    ...
    * @param index the index of the half edge that is required. Should be less than value returned by {@code getNumberOfEdges()}
    * @return
    */
    ...
    * A face edge is considered visible if its origin and destination can be connected by a straight line to the specified point without crossing any other point
    * First is defined in the counter clockwise sense w.r.t to the face normal 
   ...
   /**
    * Checks if a point is strictly on the same side of the specified edge as the face centroid, i.e. the left hand side w.r.t. to the edge
   ...
   /**
    * Returns a dot product of the vector from a point on the face to the specified point and the face normal
    * A positive value indicates that the face is visible from the point specified
    * @param point the point from which visibility of the face is to be tested
    * @return dot product result from the computation. Represents the distance of the face plane from the point
    */
   ...
   /**
    * Checks if a particular point is an interior point to the face. For a point to be an interior point it must lie in
    * the plane of the face and be strictly within the face edges
   ...
   /**
    * Gets a vector normal to the face. If the face is part of a polytope, the vector will point away from the centroid of the polytope. 
    * If the face is not part of a polytope, the direction of the vector is arbitrary
   ...
   /**
    * Geometrically evaluates if the face is within an epsilon vicinity of the specified face. 
    * This check is actually performed on the vertices that the face is composed of. Both spatial and and relations between vertices
    * are checked
    * @return {@code true} is the face is geometrically similar to the specified face, {@code false} otherwise
    */
   ...
   /**
    * Returns the largest value of the face along the specified axis (0 - X axis, 1 - Y axis, 2 - Z axis)
    * The axes are in the reference frame in which the face exists
   ...
   /**
    * Returns the smallest value of the face along the specified axis (0 - X axis, 1 - Y axis, 2 - Z axis)
    * The axes are in the reference frame in which the face exists
    * @param index the ordinal of the axis 
   ...
   /**
    * Return a reference to an adjacent face if this face is part of a polytope. If not can return a {@code null} or throw a {@code NullPointerException}
    * @param index the index of the adjacent face that is required. Should be less than {@code getNumberOfEdges()}
